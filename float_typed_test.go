...
func Test_float_CloseTo_success(t *testing.T) { gunit.Float(t, 1.1).CloseTo(1.0, 0.2) }
...
func Test_float_IsNaN_success(t *testing.T) { gunit.Float(t, math.NaN()).IsNaN() }
...
func Test_float_IsInf_success(t *testing.T) { gunit.Float(t, math.Inf(1)).IsInf() }
...
func Test_float_IsInfSign_success(t *testing.T) { gunit.Float(t, math.Inf(-1)).IsInfSign(-1) }
