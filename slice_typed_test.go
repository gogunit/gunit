...
func Test_slice_Contains_success(t *testing.T) { gunit.Slice(t, []int{1, 2, 3}).Contains(2, 3) }
...
func Test_slice_ContainsAny_success(t *testing.T) { gunit.Slice(t, []int{1, 2, 3}).ContainsAny(4, 3) }
...
func Test_slice_NotContains_success(t *testing.T) { gunit.Slice(t, []int{1, 2, 3}).NotContains(4) }
...
func Test_slice_EqualTo_success(t *testing.T) { gunit.Slice(t, []int{1, 2, 3}).EqualTo(1, 2, 3) }
...
func Test_slice_Len_success(t *testing.T) { gunit.Slice(t, make([]int, 2, 4)).Len(2) }
...
func Test_slice_Cap_success(t *testing.T) { gunit.Slice(t, make([]int, 2, 4)).Cap(4) }
...
func Test_slice_IsEmpty_success(t *testing.T) { gunit.Slice(t, []int{}).IsEmpty() }
...
func Test_slice_IsNotEmpty_success(t *testing.T) { gunit.Slice(t, []int{1}).IsNotEmpty() }
...
func Test_slice_NotEmpty_success(t *testing.T) { gunit.Slice(t, []int{1}).NotEmpty() }
...
func Test_slice_SubsetOf_success(t *testing.T) { gunit.Slice(t, []int{1, 2}).SubsetOf(1, 2, 3) }
...
func Test_slice_NotSubsetOf_success(t *testing.T) { gunit.Slice(t, []int{1, 4}).NotSubsetOf(1, 2, 3) }
