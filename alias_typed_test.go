...
func Test_string_NotContains_success(t *testing.T) { gunit.String(t, "Hello").NotContains("bye") }
...
func Test_string_NotEmpty_success(t *testing.T) { gunit.String(t, "Hello").NotEmpty() }
...
func Test_number_NotEqual_success(t *testing.T) { gunit.Number(t, 1).NotEqual(2) }
